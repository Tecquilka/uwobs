...
TARGET_DIR=/nfs/video
/usr/local/bin/ffmpeg -i udp://226.0.0.1:1234 -t "$seconds" -vcodec copy -an -f segment  -segment_time 900 $TARGET_DIR/spiddal1-$(date +"%Y%m%d%H%M")-%03d.avi
