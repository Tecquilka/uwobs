(function()
{
	...
	var midasWidget = function (settings) {
		...
		var stateArray = ["green", "amber", "red"];
                function getErddapUrl(station_id,minutes){
                      var base = "http://erddap.marine.ie/erddap/tabledap/IrishNationalTideGaugeNetwork.json?longitude,latitude,time,station_id&time>=";
    ...
    freeboard.loadWidgetPlugin({
        type_name: "tideGaugeIndicator",
        display_name: "Erddap Tide Gauge Indicator",
		external_scripts: [
