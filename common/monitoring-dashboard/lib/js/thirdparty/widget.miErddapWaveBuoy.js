(function()
{
	...
	var midasWidget = function (settings) {
		...
		var stateArray = ["green", "amber", "red"];
                function getErddapUrl(station_id,minutes){
                      var base = "http://erddap.marine.ie/erddap/tabledap/IWaveBNetwork.json?longitude,latitude,time,station_id&time>=";
    ...
    freeboard.loadWidgetPlugin({
        type_name: "waveBuoyIndicator",
        display_name: "Erddap Wave Buoy Indicator",
		external_scripts: [
